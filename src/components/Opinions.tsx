  ...
  return (
    <section className="py-24 ">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mb-16 ">
          <span className="text-sm text-sky-500 font-bold text-center block mb-2">Opinions</span>
...
function Opinion() {
  return (
    <div
      className="group bg-white border border-solid border-gray-300 flex justify-between flex-col rounded-xl p-6 transition-all duration-500  w-full mx-auto hover:border-sky-500">
      <div className="">
        <div className="flex items-center mb-7 gap-2 text-amber-500 transition-all duration-500  ">
          ...
          <span className="text-base font-semibold text-sky-500">4.9</span>
        </div>
        <p className="text-base text-gray-500 leading-6  transition-all duration-500 pb-8">
